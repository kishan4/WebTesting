...
driver.findElement(By.name("password")).sendKeys("Durgamatha123@");
...
//FileUtils.copyFile(src, new File("C:\\Users\\kkish\\Desktop\\KishanSelenium\\WebApplicationTesting\\Screenshots\\element.png"));
...
for (int i = 0; i <10; i++) {
    changeColor("rgb(0,500,0)", element,driver);//1
